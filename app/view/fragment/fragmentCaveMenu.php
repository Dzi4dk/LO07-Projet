<<<<<<< Updated upstream:app/view/fragment/fragmentCaveMenu.html

<!-- ----- début fragmentCaveMenu -->

<nav class="navbar navbar-expand-lg fixed-top" style="background-color: #ffc107;">
  <div class="container-fluid">
    <a class="navbar-brand" href="router2.php?action=CaveAccueil">CHABANNES - DELHOMME | type utilisateur | Nom Prénom </a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="router2.php?action=personneReadAllAdmins">Liste des administrateurs</a></li>
            <li><a class="dropdown-item" href="router2.php?action=compteReadAll">Liste des comptes</a></li>
            <li><a class="dropdown-item" href="router2.php?action=personneReadAllResidences">Liste des résidences</a></li>
          </ul>
        </li>
...
>>>>>>> Stashed changes:app/view/fragment/fragmentCaveMenu.php
